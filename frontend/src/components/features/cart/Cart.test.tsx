...
// import { RootState, CartProduct } from "@/lib/definitions";
...
// // Create a test store
// const createTestStore = (initialState: Partial<RootState> = { cart: [] }) => {
...
//           name: "Product 2",
//           price: 20,
//           category: { id: 2, name: "Test2", slug: "test2" },
//         },
//       ] as CartProduct[],
//     };
...
//           name: "Product 3",
//           price: 30,
//           category: { id: 3, name: "Test3", slug: "test3" },
//         },
//       ] as CartProduct[],
//     });
